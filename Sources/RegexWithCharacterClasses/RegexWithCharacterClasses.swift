...
public macro regexWithCharacterClasses(_ regexText: String) -> any RegexComponent = #externalMacro(module: "RegexWithCharacterClassesMacros", type: "RegexWithCharacterClasses")
