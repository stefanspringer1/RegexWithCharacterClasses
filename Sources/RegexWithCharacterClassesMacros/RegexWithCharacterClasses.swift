...
struct RegexWithCharacterClassesError: LocalizedError, CustomStringConvertible {
...
public struct RegexWithCharacterClasses: ExpressionMacro {
    public static func expansion<Node: FreestandingMacroExpansionSyntax,
        ...
        guard
            ...
            throw RegexWithCharacterClassesError("macro requires static string literal")
        }
        
        var text = literalSegment.content.text
        
        text = try text.replacingCharacterClassesWithRegex(usingCharacterClasses: characterClasses).replacingCharacterEntitiesWithRegex()
